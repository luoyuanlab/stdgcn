...
# ![Image text] <img src="https://github.com/luoyuanlab/stdgcn/blob/main/img_folder/logo-design-2.jpg" width="100px"> **STdGCN: accurate cell-type deconvolution using graph convolutional networks in spatial transcriptomic data**
