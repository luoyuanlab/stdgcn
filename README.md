...
# <img src="https://github.com/luoyuanlab/stdgcn/blob/main/img_folder/logo-design-2.jpg" style="float:right; margin: 5px;" class="floatright" width="200px" /> **STdGCN: accurate cell-type deconvolution using graph convolutional networks in spatial transcriptomic data**
